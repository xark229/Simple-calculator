...
% Last Modified by GUIDE v2.5 26-Nov-2022 22:58:22
...
set(handles.ini1,'string','');
set(handles.ini2,'string','');
...
A=str2double(get(handles.ini1,'string'));
B=str2double(get(handles.ini2,'string'));
c=A+B;
...
function ini2_Callback(hObject, eventdata, handles)
% hObject    handle to ini2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ini2 as text
%        str2double(get(hObject,'String')) returns contents of ini2 as a double


% --- Executes during object creation, after setting all properties.
function ini2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ini2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in subs.
function subs_Callback(hObject, eventdata, handles)
% hObject    handle to subs (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of subs
A=str2double(get(handles.ini1,'string'));
B=str2double(get(handles.ini2,'string'));
c=A-B;
set(handles.edit3,'string',num2str(c));
...
% --- Executes on button press in mulpiply.
function mulpiply_Callback(hObject, eventdata, handles)
% hObject    handle to mulpiply (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of mulpiply
A=str2double(get(handles.ini1,'string'));
B=str2double(get(handles.ini2,'string'));
c=A*B;
set(handles.edit3,'string',num2str(c));
